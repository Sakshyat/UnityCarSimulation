...
public class Connection
{
    ...
    //private GameObject GoalNode1;
    //private GameObject GoalNode2;
    ...
    public void SetConnection(GameObject FromNode, GameObject ToNode, float DefaultPheromoneLevel)
    {
        ...
        //distance1 = Vector3.Distance(GoalNode1.transform.position, GoalNode2.transform.position);
        // distance2 = Vector3.Distance(GoalNode2.transform.position, ToNode.transform.position);
